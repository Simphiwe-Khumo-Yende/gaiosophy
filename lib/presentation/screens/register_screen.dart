        ...
        return Theme(
          data: Theme.of(context).copyWith(
            colorScheme: ColorScheme.light(
              primary: const Color(0xFF1A1612),
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            color: const Color(0xFF1A1612).withOpacity(0.1),
                          ),
                        ),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Icon(
                              Icons.eco_outlined,
                              size: 30,
                              color: const Color(0xFF1A1612).withOpacity(0.5),
                            ),
                        ...
                        child: Column(
                          ...
                          children: [
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: _currentStep >= 1 
                                          ...
                                          : const Color(0xFF1A1612).withOpacity(0.3),
                                      borderRadius: BorderRadius.circular(2),
                                    ),
                                  ),
                                ),
                            ...
                            if (_currentStep == 0) ...[
                              TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  enabledBorder: UnderlineInputBorder(
                                    borderSide: BorderSide(color: const Color(0xFF1A1612).withOpacity(0.3)),
                                  ),
                              ...
                              TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  helperStyle: TextStyle(color: const Color(0xFF1A1612).withOpacity(0.7)),
                                ),
                            ...
                            if (_currentStep == 1) ...[
                              TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  labelStyle: const TextStyle(color: Color(0xFF1A1612)),
                                  prefixIcon: const Icon(Icons.person_outline, color: Color(0xFF1A1612)),
                                  enabledBorder: UnderlineInputBorder(
                                    borderSide: BorderSide(color: const Color(0xFF1A1612).withOpacity(0.3)),
                                  ),
                                  focusedBorder: const UnderlineInputBorder(
                              ...
                              TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  labelStyle: const TextStyle(color: Color(0xFF1A1612)),
                                  prefixIcon: const Icon(Icons.calendar_today, color: Color(0xFF1A1612)),
                                  enabledBorder: UnderlineInputBorder(
                                    borderSide: BorderSide(color: const Color(0xFF1A1612).withOpacity(0.3)),
                                  ),
                                  focusedBorder: const UnderlineInputBorder(
                              ...
                              DropdownButtonFormField<String>(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  labelStyle: const TextStyle(color: Color(0xFF1A1612)),
                                  prefixIcon: const Icon(Icons.star_outline, color: Color(0xFF1A1612)),
                                  enabledBorder: UnderlineInputBorder(
                                    borderSide: BorderSide(color: const Color(0xFF1A1612).withOpacity(0.3)),
                                  ),
                                  focusedBorder: const UnderlineInputBorder(
                                ...
                                items: _zodiacSigns.map((String sign) {
                                  return DropdownMenuItem<String>(
                                    value: sign,
                                    child: Text(sign, style: const TextStyle(color: Color(0xFF1A1612))),
                                  );
                                }).toList(),
                                  ...
                                  Expanded(
                                    child: OutlinedButton(
                                      ...
                                      style: OutlinedButton.styleFrom(
                                        ...
                                        side: const BorderSide(color: Color(0xFF1A1612)),
                            ...
                            if (_currentStep == 0) ...[
                              ...
                              Row(
                                children: [
                                  Expanded(child: Divider(color: const Color(0xFF1A1612).withOpacity(0.3))),
                                  const Padding(
                                    padding: EdgeInsets.symmetric(horizontal: 16),
                                    child: Text('or', style: TextStyle(color: Color(0xFF1A1612))),
                                  ),
                                  Expanded(child: Divider(color: const Color(0xFF1A1612).withOpacity(0.3))),
                                ],
                              ),
                              ...
                              OutlinedButton.icon(
                                ...
                                icon: const Icon(Icons.login, color: Color(0xFF1A1612)),
                                label: const Text(
                                  'Sign up with Google',
